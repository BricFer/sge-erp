...
return new class extends Migration
{
    ...
    {
        Schema::create('detalle_factura_servicio', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('estado', ['activo', 'pendiente', 'completado'])->default('pendiente');
    ...
    {
        Schema::dropIfExists('detalle_factura_servicio');
    }
};
