        ...
        <div class="w-full p-6">
            ...
            <div class="w-full flex flex-wrap gap-1 justify-content">
                <div class="flex flex-col gap-1 w-[205px] ">
                    ...
                    <p class="h-[42px] p-2 w-full dark:text-[#EDEDEC] border-[#19140035] hover:border-[#1915014a] border text-[#1b1b18] dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-sm leading-normal">Compra</p>
                    <input
                ...
                <div class="flex flex-col gap-1 w-[456px]">
                    ...
                    <div class="w-full flex gap-1">
                        <p id="id_proveedor" class="h-[42px] w-[45px] p-2 dark:text-[#EDEDEC] border-[#19140035] hover:border-[#1915014a] border text-[#1b1b18] dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-sm leading-normal"></p>
                        ...
                        >
                            ...
                            <option class="font-bold bg-transparent" disabled selected>Seleccionar proveedor</option>
                ...
                <div class="flex flex-col gap-1 w-[215px]">
                    <span for="cif" class="w-full">CIF</span>
