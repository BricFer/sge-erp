<div class="w-full flex flex-row flex-wrap items-center gap-6 text-nowrap bg-indigo-600 text-white p-4 sticky top-0 right-0 left-0 font-bold">
    <p class="w-[175px]">Nombre</p>
    <p class="w-[95px]">@yield('campo1','')</p>
    <p class="w-[115px]">@yield('campo2','')</p>
