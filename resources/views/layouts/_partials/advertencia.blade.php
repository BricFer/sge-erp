<div id="contenedor-mensaje" class="fixed inset-0 flex items-center justify-center bg-[#0a0a0a]/40 hidden h-screen">
    ...
    <div id="warning-message" class="w-[450px] relative bg-[#FDFDFC]/95 rounded-2xl shadow-xl shadow-white/20">
        ...
        <div class="w-full flex flex-row justify-center gap-4 py-4 m-0">
            ...
            <button id="cancelar" class="block text-center border-2 border-red-700 p-2 bg-red-700 text-white rounded-lg w-36">Cancelar</button>
            ...
            >
                ...
                <input
                    type="submit"
                    value="Confirmar"
                    class="block text-center border-2 border-indigo-600 p-2 bg-indigo-600 text-white rounded-lg w-36 cursor-pointer"
                />
            </form>
