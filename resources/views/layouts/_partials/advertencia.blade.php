<div id="contenedor-mensaje" class="absolute inset-0 flex items-center justify-center bg-white/40 hidden">
    
    <div id="warning-message" class="w-[450px] bg-white rounded-2xl shadow-xl shadow-black/20 relative top-[50%] left-[50%] ml-[-225px] mt-[-70px] m-auto">
        ...
        <div class="w-full p-2 m-0">
            ...
            <p class="font-bold uppercase my-2">Esta acción no se podrá deshacer.</p>
        </div>
